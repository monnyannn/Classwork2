...
app.get("/signup", function(req, res) {
  ...
  res.sendFile(__dirname + "/signup.html") //create a index file 
...
res.sendFile(__dirname + "/usersuccess.html") //create a index file 
...
MongoClient.connect("mongodb+srv://monnyann:Tania1007@cluster0-unidc.mongodb.net/test?retryWrites=true&w=majority", function(err, db) {
  if(!err) {
  p = db
